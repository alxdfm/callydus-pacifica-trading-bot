...
export const messages = {
  en: {
    ...
    builderStopLossVolumeProfile: "Value area",
    builderVolumeProfilePeriodLabel: "Profile period",
    builderVolumeProfileBufferLabel: "Buffer %",
    ...
    builderSavedMessage: "Strategy saved.",
    builderActivatedMessage: "Strategy activated.",
    builderPausedMessage: "Strategy paused.",
