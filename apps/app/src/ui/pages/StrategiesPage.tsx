...
const allowedStrategySymbols = presetSymbolSchema.options;
...
export function StrategiesPage() {
  ...
  async function handleActivateYourStrategy() {
    if (!state.wallet.mainWalletPublicKey) {
      setPresetState({
    ...
    <div className="page-stack">
      ...
      <section className="backtest-preview strategy-builder-panel">
        ...
        <YourStrategyWizard
          ...
          onActivate={() => void handleActivateYourStrategy()}
          ...
          <div className="form-stack">
            ...
            <label className="onboarding-form__field">
              ...
              <select
                ...
                value={draft.symbol}
              >
                {allowedStrategySymbols.map((symbol) => (
