...
## Objetivo
Traduzir as decisões de layout e navegação em wireframes textuais para orientar design, frontend e QA sem ambiguidade estrutural.
...
## Regras de Leitura
- o wireframe define estrutura e prioridade, não estética final
- o Dashboard prioriza estado e ação
- a tela de Presets prioriza comparação e ativação
- a navegação deve permanecer rasa e previsível

## Recomendação Final
Usar estes wireframes como base de implementação antes de entrar em refinamento visual.
